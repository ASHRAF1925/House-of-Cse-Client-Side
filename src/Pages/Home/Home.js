...
const Home = () => {
  return (
   ...
   <div className="my-5">
    ...
    <p className="my-5">We have a fully qualified and very well educated teaching staff, continuous student counseling, and a very effective and enthusiastic student support staff. </p>
